export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от ИИ аналитика предприятий питания. На базе GigaChat",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в ИИ аналитика предприятий питания. На базе GigaChat.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в ИИ аналитика предприятий питания. На базе GigaChat.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в ИИ аналитика предприятий питания. На базе GigaChat.",
  ...
  "dialog.server.description": "Переключите сервер ИИ аналитика предприятий питания. На базе GigaChat к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия ИИ аналитика предприятий питания. На базе GigaChat ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде ИИ аналитика предприятий питания. На базе GigaChat",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что ИИ аналитика предприятий питания. На базе GigaChat пока не поддерживает MCP авторизацию.',
  ...
  "session.report.generate": "Сгенерировать отчёт",
  "session.report.regenerate": "Перегенерировать",
  "session.report.menuHeading": "Выберите скилл",
  ...
  "sidebar.help": "Помощь",
  "sidebar.heading.workspaces": "Пространства",
  "sidebar.heading.chats": "Чаты",
  "sidebar.heading.reports": "Отчёты и дашборды",
  "sidebar.heading.files": "Файлы",
  "sidebar.reports.empty": "Нет скиллов-отчётов",
  ...
  "sidebar.gettingStarted.line1": "ИИ аналитика предприятий питания. На базе GigaChat включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "sidebar.search.placeholder": "Поиск по сессиям",
  "sidebar.search.scope.current": "Текущее пространство",
  "sidebar.search.scope.all": "Все пространства",
  "sidebar.search.noResults": "Нет сессий, соответствующих запросу",
  ...
  "settings.desktop.wsl.description": "Запускать сервер ИИ аналитика предприятий питания. На базе GigaChat внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения ИИ аналитика предприятий питания. На базе GigaChat",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске ИИ аналитика предприятий питания. На базе GigaChat",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию ИИ аналитика предприятий питания. На базе GigaChat.",
