...
export namespace Ripgrep {
  ...
  const resultRow = Schema.Union([begin, match, end, summary])

  const decode = Schema.decodeUnknownSync(Schema.fromJsonString(resultRow))
  ...
  export const Result = zod(resultRow)
